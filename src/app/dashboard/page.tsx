...
`}</style>
      <div className="flex flex-col gap-5 pt-12 px-2 pb-24">
           ...
           {/* Bande défilante - w-full pour presque tout l'écran */}
           ...
           {/* Météo - w-full pour presque tout l'écran */}
           ...
           <div className="mt-8 w-full">
             ...
             <div className="flex gap-3 overflow-x-auto pb-4 snap-x scrollbar-hide w-full">
               {partenaires.map((partenaire: any) => (
                 <div key={partenaire.id} className="min-w-[280px] bg-white/20 rounded-[24px] border border-white/30 backdrop-blur-xl shadow-lg p-4 flex flex-col items-center text-center snap-center">
                   {partenaire.photo_url ? (
                     ...
                     <div className="w-16 h-16 rounded-full bg-[#FF7A00]/20 flex items-center justify-center mb-3 text-3xl">
                       🏢
                     </div>
                   )}
               ...
               <div className="min-w-[280px] bg-white/10 rounded-[24px] border-2 border-dashed border-white/30 p-4 flex flex-col items-center justify-center text-center snap-center backdrop-blur-xl">
