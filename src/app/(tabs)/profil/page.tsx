          ...
          <div className="w-full py-4">
            ...
            <div className="space-y-5">
              ...
              <button type="button" onClick={handleLogout} aria-label="Se déconnecter"
                className="flex items-center justify-center gap-2 rounded-[14px] border-2 py-2.5 text-sm font-black transition-all active:scale-[0.98] bg-red-500/20 border-red-400/30 text-red-300 shadow-lg mx-2"
              >
